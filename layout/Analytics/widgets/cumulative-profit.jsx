...
export default function CumulativeProfit({
  data,
  isLoading,
  chartTypesRef,
  handleDeleteWidget,
  ...
  const [chartType, setChartType] = useState(
    chartTypesRef.current["cumulative-profit"] ?? "linear"
  );
  ...
  const [series, categories] = useMemo(() => {
    ...
    data.forEach((deal) => {
      ...
      commissions[date] += parseFloat(deal.profit);
    });
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  const n = {
                    ...
                    "cumulative-profit": e.target.value,
                  };
